...
static struct clk_lookup omap44xx_clks[] = {
	...
	CLKDEV_INIT("omap-mcbsp.1",	"pad_fck",		&pad_clks_ck),
	CLKDEV_INIT("omap-mcbsp.2",	"pad_fck",		&pad_clks_ck),
	CLKDEV_INIT("omap-mcbsp.3",	"pad_fck",		&pad_clks_ck),
	CLKDEV_INIT("omap-mcbsp.4",	"pad_fck",		&pad_clks_ck),
	...
	CLKDEV_INIT(NULL,	"dbgclk_mux_ck",		&dbgclk_mux_ck),
	...
	CLKDEV_INIT(NULL,	"fdif_fck",			&fdif_fck),
	...
	CLKDEV_INIT(NULL,	"hsi_fck",			&hsi_fck),
	...
	CLKDEV_INIT("usbhs_omap",	"usbtll_ick",		&usb_tll_hs_ick),
...
{
	static struct clk_lookup *omap4_specific_clks;

	if (cpu_is_omap443x()) {
		cpu_mask = RATE_IN_4430;
		omap4_specific_clks = omap443x_clks;
	...
	omap2_clks_register(omap4_specific_clks);
